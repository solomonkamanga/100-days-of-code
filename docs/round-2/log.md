...
**Today's Progress:** Still working on Intermediate Algorithm Scripting from [freeCodeCamp](https://www.freecodecamp.org). Only managed to write a function for one algorithm: Search and Replace.
...
**Today's Progress:** Finally finished working on portfolio website (using HTML, CSS & JavaScript). Next step is to turn this "masterpiece" into a WordPress theme.
...
## Day 86: September 8, 2020

**Today's Progress:** Completed MVC Frameworks for Building PHP Web Applications on [LinkedIn Learning](https://www.linkedin.com/learning). 
